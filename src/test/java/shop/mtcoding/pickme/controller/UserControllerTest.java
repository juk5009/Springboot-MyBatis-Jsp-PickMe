...
public class UserControllerTest {
    ...
    public void join_test() throws Exception {
        ...
        String requestBody = "userName=ssar&userPassword=1234&userEmail=ssar@nate.com";

        // when
        ResultActions resultActions = mvc.perform(post("/userJoin").content(requestBody)
    ...
    public void login_test() throws Exception {
        // given
        String requestBody = "userName=ssar&userPassword=1234";

        // when
        ResultActions resultActions = mvc.perform(post("/userlogin").content(requestBody)
                .contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE));
