          ...
          <div class="col-md-7 col-lg-6 justify-content-center">
            ...
            <form id="my-saveNoticeForm-content-form-1" >
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                    <input type="text" class="form-control" name="noticeTitle" id="noticeTitle" value="" placeholder="제목을 입력해주세요"
                      required>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" name="noticeCareer" id="noticeCareer" placeholder="ex) 신입" value="" required>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" name="noticePay" id="noticePay" placeholder="ex) 3000만원" value=""
                    required>
                </div>
                ...
                <div class="my-saveNoticeForm-summernote container my-3">
                  <form class="mb-1">
                    ...
                    <div class="form-group">
                      <textarea class="form-control summernote" rows="5" name="noticeContent" id="noticeContent" value="" ></textarea>
                    </div>
              ...
              <div class="my-saveNoticeForm-submit-btn-1 mycol-md-12">
                <button class="w-100 btn btn-success btn-lg" onclick="saveNotice()" type="button">공고 등록</button>
              </div>
